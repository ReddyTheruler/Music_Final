...
<body>
<center>
<p><a href="index.php">Home</a> | <a href="insert.php">Upload New video</a> | 
...
<select name="stime" id="stime">
  ...
  <option value="Telugusongs">Telugusongs</option>
   <option value="Partysongs">Partysongs</option>
  <option value="romanticsongs">romanticsongs</option>
  <option value="ghazalsongs">ghazalsongs</option>
   <option value="othersongs">othersongs</option>
</select>  
