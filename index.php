...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-3 bgblue"><div class="thumbnail" id="thumb4">
			<a href="Telugusongs.php">
				<img src="resources/telgu.jpg" alt="Telgu image">
				<div class="caption text-center cat-caption">Telugu Songs</div>
			</a>
			</div></div>
	</div>
